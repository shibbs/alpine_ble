...
//original code from https://devzone.nordicsemi.com/question/798/is-there-an-example-code-for-using-pwm-on-the-nrf51822-with-a-softdevice/?sort=votes&amp;page=1#sort-top 
...
typedef enum
{
    PWM_MODE_LED_100,   // 0-100 resolution, 156 Hz PWM frequency, 32 kHz timer frequency (prescaler 9) //use this for now. FLAG SAH we need to determine the optimal holding torque frequency for these motors
