#line 1 "..\\localLibs\\app_state_machine.c"
...
#line 30 "..\\localLibs\\app_state_machine.c"
...
#line 31 "..\\localLibs\\app_state_machine.c"
...
#line 32 "..\\localLibs\\app_state_machine.c"
#line 33 "..\\localLibs\\app_state_machine.c"
#line 34 "..\\localLibs\\app_state_machine.c"

#line 36 "..\\localLibs\\app_state_machine.c"
#line 37 "..\\localLibs\\app_state_machine.c"
...
static void on_write(ble_sm_t * p_ble_sm, ble_evt_t * p_ble_evt)
{
	...
	if ((p_evt_write->handle == p_ble_sm->ble_sm_shutter_char_handles.value_handle) &&
				...
				(p_ble_sm->shutter_write_handler != 0))
	{
	...
	if ((p_evt_write->handle == p_ble_sm->ble_sm_tl_pkt_char_handles.value_handle) &&
				...
				(p_ble_sm->tl_pkt_write_handler != 0))
	{
...
static uint32_t sm_state_char_add(ble_sm_t * p_ble_sm, const ble_sm_init_t * p_ble_sm_init)
{
    ...
    {
        p_ble_sm->report_ref_handle = 0x0000;
    }
...
uint32_t ble_sm_init(ble_sm_t * p_ble_sm, const ble_sm_init_t * p_ble_sm_init)
{
    ...
    p_ble_sm->conn_handle               = 0xFFFF;
		...
		ble_uuid128_t base_uuid = {0xB3, 0x26, 0x11, 0x0C, 0x01, 0x10, 0xC1, 0x79, 0x82, 0xCA, 0x38, 0x72,0x00, 0x00, 0x02, 0xB6 };
    ...
    err_code = sd_ble_gatts_service_add(0x01, &ble_uuid, &p_ble_sm->service_handle);
    if (err_code != ((0x0) + 0))
    {
        return err_code;
    }
