...
static void tl_pkt_write_handler(ble_sm_t * p_ble_sm, uint8_t* tl_pkt)
{
	...
	if(packet_num == num_packets){
		if( Tl_pkt_is_good( tl_pkt ) ) AddEventToTlSmQueue(3);
...
static void services_init(void)
{
		...
		do { const uint32_t LOCAL_ERR_CODE = (err_code); if (LOCAL_ERR_CODE != ((0x0) + 0)) { do { app_error_handler((LOCAL_ERR_CODE), 329, (uint8_t*) "..\\main.c"); } while (0); } } while (0);	
...
static void on_conn_params_evt(ble_conn_params_evt_t * p_evt)
{
    ...
    if(p_evt->evt_type == BLE_CONN_PARAMS_EVT_FAILED)
    {
        ...
        do { const uint32_t LOCAL_ERR_CODE = (err_code); if (LOCAL_ERR_CODE != ((0x0) + 0)) { do { app_error_handler((LOCAL_ERR_CODE), 365, (uint8_t*) "..\\main.c"); } while (0); } } while (0);
    }
}
...
{
    do { app_error_handler((nrf_error), 376, (uint8_t*) "..\\main.c"); } while (0);
}
...
static void timers_start(void)
{
	...
	do { const uint32_t LOCAL_ERR_CODE = (err_code); if (LOCAL_ERR_CODE != ((0x0) + 0)) { do { app_error_handler((LOCAL_ERR_CODE), 409, (uint8_t*) "..\\main.c"); } while (0); } } while (0);
}
...
static void advertising_start(void)
{
    ...
    do { const uint32_t LOCAL_ERR_CODE = (err_code); if (LOCAL_ERR_CODE != ((0x0) + 0)) { do { app_error_handler((LOCAL_ERR_CODE), 430, (uint8_t*) "..\\main.c"); } while (0); } } while (0);
    nrf_gpio_pin_set(16);
}
...
static void on_ble_evt(ble_evt_t * p_ble_evt)
{
    ...
    switch (p_ble_evt->header.evt_id)
    {
        ...
        case BLE_GATTS_EVT_SYS_ATTR_MISSING:
            ...
            do { const uint32_t LOCAL_ERR_CODE = (err_code); if (LOCAL_ERR_CODE != ((0x0) + 0)) { do { app_error_handler((LOCAL_ERR_CODE), 486, (uint8_t*) "..\\main.c"); } while (0); } } while (0);
            break;
        ...
        case BLE_GAP_EVT_SEC_INFO_REQUEST:
            ...
            else
            {
                ...
                do { const uint32_t LOCAL_ERR_CODE = (err_code); if (LOCAL_ERR_CODE != ((0x0) + 0)) { do { app_error_handler((LOCAL_ERR_CODE), 504, (uint8_t*) "..\\main.c"); } while (0); } } while (0);
            }
            break;
        ...
        case BLE_GAP_EVT_TIMEOUT:
            if (p_ble_evt->evt.gap_evt.params.timeout.src == 0x00)
            {
                ...
                do { const uint32_t LOCAL_ERR_CODE = (err_code); if (LOCAL_ERR_CODE != ((0x0) + 0)) { do { app_error_handler((LOCAL_ERR_CODE), 520, (uint8_t*) "..\\main.c"); } while (0); } } while (0);
            }
            break;
...
static void ble_stack_init(void)
{
    ...
    do { const uint32_t LOCAL_ERR_CODE = (err_code); if (LOCAL_ERR_CODE != ((0x0) + 0)) { do { app_error_handler((LOCAL_ERR_CODE), 585, (uint8_t*) "..\\main.c"); } while (0); } } while (0);
...
{
    do { static uint32_t APP_SCHED_BUF[((((((((sizeof(app_timer_event_t))) + 8) * (((10)) + 1))) - 1) / (sizeof(uint32_t))) + 1)]; uint32_t ERR_CODE = app_sched_init((sizeof(app_timer_event_t)), (10), APP_SCHED_BUF); do { const uint32_t LOCAL_ERR_CODE = (ERR_CODE); if (LOCAL_ERR_CODE != ((0x0) + 0)) { do { app_error_handler((LOCAL_ERR_CODE), 597, (uint8_t*) "..\\main.c"); } while (0); } } while (0); } while (0);
}
...
{
    do { static uint32_t app_gpiote_buf[((((((1) * 20)) - 1) / (sizeof(uint32_t))) + 1)]; uint32_t ERR_CODE = app_gpiote_init((1), app_gpiote_buf); do { const uint32_t LOCAL_ERR_CODE = (ERR_CODE); if (LOCAL_ERR_CODE != ((0x0) + 0)) { do { app_error_handler((LOCAL_ERR_CODE), 630, (uint8_t*) "..\\main.c"); } while (0); } } while (0); } while (0);
}
...
static void input_interrupts_init(void)
{
    ...
    do { uint32_t ERR_CODE = app_button_init((buttons), (sizeof(buttons) / sizeof(buttons[0])), (((uint32_t)((((50) * (uint64_t)32768) + ((((8) + 1) * 1000) / 2)) / (((8) + 1) * 1000)))), (1) ? app_button_evt_schedule : 0); do { const uint32_t LOCAL_ERR_CODE = (ERR_CODE); if (LOCAL_ERR_CODE != ((0x0) + 0)) { do { app_error_handler((LOCAL_ERR_CODE), 647, (uint8_t*) "..\\main.c"); } while (0); } } while (0); } while (0);
...
static void power_manage(void)
{
    ...
    do { const uint32_t LOCAL_ERR_CODE = (err_code); if (LOCAL_ERR_CODE != ((0x0) + 0)) { do { app_error_handler((LOCAL_ERR_CODE), 660, (uint8_t*) "..\\main.c"); } while (0); } } while (0);
}
