...
static uint32_t pwm_max_value, pwm_next_value[3], pwm_io_ch[3], pwm_running[3];
...
uint32_t nrf_pwm_init(nrf_pwm_config_t *config)
{
    ...
    switch(config->mode)
    {
        case PWM_MODE_LED_100:   
            ((NRF_TIMER_Type *) 0x4000A000UL)->PRESCALER = 9;  
            pwm_max_value = 100;
            break;
        case PWM_MODE_LED_255:   
            ((NRF_TIMER_Type *) 0x4000A000UL)->PRESCALER = 8;
            pwm_max_value = 255;        
            break;
        case PWM_MODE_LED_1000:  
            ((NRF_TIMER_Type *) 0x4000A000UL)->PRESCALER = 5;
            pwm_max_value = 1000;
            break;
        case PWM_MODE_MTR_100:   
            ((NRF_TIMER_Type *) 0x4000A000UL)->PRESCALER = 2;
            pwm_max_value = 100;
            break;
        case PWM_MODE_MTR_255:    
            ((NRF_TIMER_Type *) 0x4000A000UL)->PRESCALER = 0;
            pwm_max_value = 255;
            break;
        default:
            return 0xFFFFFFFF;
    ...
    ((NRF_TIMER_Type *) 0x4000A000UL)->TASKS_CLEAR = 1;
		((NRF_TIMER_Type *) 0x4000A000UL)->BITMODE = (0x00UL);
    ((NRF_TIMER_Type *) 0x4000A000UL)->CC[3] = pwm_max_value*2;
		((NRF_TIMER_Type *) 0x4000A000UL)->MODE = (0UL);
    ((NRF_TIMER_Type *) 0x4000A000UL)->SHORTS = (0x1UL << (3UL));
    ((NRF_TIMER_Type *) 0x4000A000UL)->EVENTS_COMPARE[0] = ((NRF_TIMER_Type *) 0x4000A000UL)->EVENTS_COMPARE[1] = ((NRF_TIMER_Type *) 0x4000A000UL)->EVENTS_COMPARE[2] = ((NRF_TIMER_Type *) 0x4000A000UL)->EVENTS_COMPARE[3] = 0;     

    for(int i = 0; i < pwm_num_channels; i++)
    {
        ppi_enable_channel(config->ppi_channel[i*2],  &((NRF_TIMER_Type *) 0x4000A000UL)->EVENTS_COMPARE[i], &((NRF_GPIOTE_Type *) 0x40006000UL)->TASKS_OUT[pwm_gpiote_channel[i]]);
        ppi_enable_channel(config->ppi_channel[i*2+1],&((NRF_TIMER_Type *) 0x4000A000UL)->EVENTS_COMPARE[3], &((NRF_GPIOTE_Type *) 0x40006000UL)->TASKS_OUT[pwm_gpiote_channel[i]]);        
    }
    ...
    ((NRF_TIMER_Type *) 0x4000A000UL)->TASKS_START = 1;
    return 0;
}
...
void nrf_pwm_set_value(uint32_t pwm_channel, uint32_t pwm_value)
{
    ...
    ((NRF_TIMER_Type *) 0x4000A000UL)->EVENTS_COMPARE[3] = 0;
    ((NRF_TIMER_Type *) 0x4000A000UL)->SHORTS = (0x1UL << (3UL)) | (0x1UL << (11UL));
    if((((NRF_TIMER_Type *) 0x4000A000UL)->INTENSET & (0x1UL << (19UL))) == 0)
    {
        ((NRF_TIMER_Type *) 0x4000A000UL)->TASKS_STOP = 1;
        ((NRF_TIMER_Type *) 0x4000A000UL)->INTENSET = (0x1UL << (19UL));  
    }
    ((NRF_TIMER_Type *) 0x4000A000UL)->TASKS_START = 1;
}
...
void TIMER2_IRQHandler(void)
{
    static uint32_t i;
    ((NRF_TIMER_Type *) 0x4000A000UL)->EVENTS_COMPARE[3] = 0;
    ((NRF_TIMER_Type *) 0x4000A000UL)->INTENCLR = 0xFFFFFFFF;
    for(i = 0; i < pwm_num_channels; i++)
    {
        ...
        {
            ((NRF_TIMER_Type *) 0x4000A000UL)->CC[i] = pwm_next_value[i] * 2;
            if(!pwm_running[i])
            {
